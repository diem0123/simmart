...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Thông tin công ty
			<small>Gồm {{count($data)}} thông tin</small>
		</h1>
	</section>
	<div class="row" style="padding: 15px;padding-bottom:5px;margin-top: 10px;">
		...
		<div class="col-md-8" style="padding-left: ">
			<small class="pull-right">
				<a href="{{url('admin/footer/info/insert')}}" class="btn btn-info"><i class="fa fa-plus-circle"></i> Thêm mới</a>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content"  style="width: 60%;margin-left: 130px;border-radius: 5px;">
							...
							<div class="modal-footer" style="padding-top: 10px;padding-bottom: 10px;">
								<a href="{{url('admin/info/deleteall')}}" class="btn btn-danger">OK</a>
				...
				<div class="box">
					...
					<div class="box-body" style="padding-left: 30px;padding-right: 30px;">
						<div class="row">
							<div class="data">
								<?php $dem = count($data); ?>
								<div class="colhead" <?php if($dem>4){echo "style='padding-right:15px;'";} ?>>
									<div class="col3" style="border-left: none;"><h4><strong>Icon</strong></h4></div>
									<div class="col3"><h4><strong>Thông tin</strong></h4></div>
								...
								<div class="scrolll" id="style-1">
									<div class="searchable-container">
										...
										<div class="itemss sud">
											...
											<div class="value3">
												<a href="{{url('admin/footer/info/update/'.$row->id)}}" class="btn btn-info" ><i class="fa fa-wrench" aria-hidden="true"></i> Sửa</a>
												...
												<div id="areyouok{{$d}}" class="modal fade" role="dialog" style="margin-top: 50px;">
													<div class="modal-dialog">
														...
														<div class="modal-content"  style="width: 60%;margin-left: 130px;border-radius: 5px;">
															...
															<div class="modal-footer" style="padding-top: 10px;padding-bottom: 10px;">
																<a href="{{url('admin/footer/info/delete/'.$row->id)}}" class="btn btn-danger">OK</a>
																<button type="button" class="btn btn-default" data-dismiss="modal">Trở lại</button>
															</div>
														</div>
													</div>

@extends('masteradmin')
@section('title', 'Quản lý Nhà mạng')
@section('noidung')
...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Quản lý Nhà mạng
      <small>Gồm {{$count}} nhà mạng</small>
    </h1>
  </section>
    ...
    <div class="col-md-8" style="padding-left: ">
      <small class="pull-right">
        ...
        <div id="insert" class="modal fade" role="dialog" style="margin-top: 50px;">
          ...
          <form id="registrationForm" action="{{url('admin/nhamang/postinsert')}}" method="POST" enctype="multipart/form-data">
           {{csrf_field()}}
            ...
            <div class="modal-content"  style="width: 60%;margin-left: 130px;border-radius: 5px;">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input value="{{old('name')}}" type="text" class="form-control" name="name" placeholder="Tên nhà mạng">
                </div>
              </div>
      ...
      <div id="deleteall" class="modal fade" role="dialog" style="margin-top: 50px;">
        <div class="modal-dialog">
          <div class="modal-content"  style="width: 60%;margin-left: 130px;border-radius: 5px;">
            ...
            <div class="modal-footer" style="padding-top: 10px;padding-bottom: 10px;">
              <a href="{{url('admin/nhamang/deleteall')}}" class="btn btn-danger">OK</a>
          ...
          <div class="row">
            <div class="data">
              ...
              <div class="colhead" <?php if($dem>8){echo "style='padding-right:15px;'";} ?>>
                ...
                <div class="col3"><h4><strong>Tên nhà mạng</strong></h4></div>
              ...
              <div class="scrolll" id="style-1">
                <div class="searchable-container">
                  ...
                  <div class="itemss sud">
                    ...
                    <div class="value3">
                      <a href="{{url('admin/nhamang/update/'.$row->id)}}" class="btn btn-info" ><i class="fa fa-wrench" ></i> Sửa</a>
                      ...
                      <div id="areyouok{{$d}}" class="modal fade" role="dialog" style="margin-top: 50px;">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content"  style="width: 60%;margin-left: 130px;border-radius: 5px;">
                            ...
                            <div class="modal-footer" style="padding-top: 10px;padding-bottom: 10px;">
                              <a href="{{url('admin/nhamang/delete/'.$row->id)}}" class="btn btn-danger">OK</a>
                              <button type="button" class="btn btn-default" data-dismiss="modal">Trở lại</button>
                            </div>
                          </div>
